...
<div class="bg-blue-darker p-2 shadow text-xl text-white mt-10">
   <h3 class="pl-2">Update tag</h3>
</div>
<div class="flex flex-wrap m-5">
{{ Form::open([
'method' => 'PATCH',
'route' => ['admin.tags.update', $item->id],
...
<div class="flex flex-wrap -mx-3 mb-6">
   <div class="w-full md:w-1/2 px-3">
      ...
      <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey" name="name" id="grid-name" type="text" placeholder="Awesome tag" value="{{$item->name}}">
   </div>
</div>
<div class="flex flex-wrap -mx-3 mb-6">
...
<div class="md:flex md:items-center">
   <div class="md:w-2/3">
      ...
      <a href="{{ route('admin.tags.index') }}" class="bg-grey-light hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded">Cancel</a>
   </div>
</div>
@endsection