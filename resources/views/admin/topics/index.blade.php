       ...
       @endforeach
                    ...
                    <div class="bg-white border-transparent rounded-lg shadow-lg">
                        <div class="bg-grey-light border-b-2 border-grey rounded-tl-lg rounded-tr-lg p-2">
                            ...
                            <a class="bg-grey-light hover:bg-grey text-grey-darkest font-semibold py-2 px-4 border border-grey-light rounded shadow" href="{{ route('admin.topics.create') }}"><i class="fa fa-plus"></i> Add topic</a>
                            ...
                            <table class="w-full p-5 text-grey-darker table-collapse">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left text-blue-darkest">Topic name</th>
                                        <th class="text-left text-blue-darkest">Slug</th>
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                      ...
                                      <td class="p-2 border-t border-grey-light font-mono text-xs whitespace-no-wrap">{{ $item->name}}</td>

                                      <td class="p-2 border-t border-grey-light font-mono text-xs whitespace-no-wrap">{{ $item->slug}}</td>
                                      ...
                                      <td class="p-2 border-t border-grey-light font-mono text-xs text-purple-dark">
                                         ...
                                         <a title="Update"  href="{{ route('admin.topics.edit', $item->id) }}" class="bg-grey-light hover:bg-grey text-grey-darkest font-bold py-2 px-4 rounded mt-4">Edit</a>

                                         {{ Form::open(['method' => 'DELETE','route' => ['admin.topics.destroy', $item->id]]) }}
            {{ Form::submit('Delete', ['class' => 'bg-red hover:bg-grey text-white font-bold py-2 px-4 rounded mt-4']) }}
         {{ Form::close() }}
