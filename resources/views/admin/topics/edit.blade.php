...
<div class="flex flex-wrap m-5">
   ...
   <div class="flex flex-wrap -mx-3 mb-6">
      <div class="md:w-1/2 px-3">
         ...
         <input class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-grey" name="name" id="grid-name" type="text" placeholder="Awesome topic" value="{{$item->name}}">
      </div>
   </div>
   <div class="flex flex-wrap -mx-3 mb-6">
